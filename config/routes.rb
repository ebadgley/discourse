...
Discourse::Application.routes.draw do
  ...
  scope "/tags" do
    ...
    constraints(tag_id: /[^\/]+?/, format: /json|rss/) do
      ...
      get '/intersection/:tag_id/*additional_tag_ids' => 'tags#show', match_all_tags: true, as: 'tag_intersection'
      get '/union/:tag_id/*additional_tag_ids' => 'tags#show', as: 'tag_union'
