...
// The tags-union route is exactly the same as the tags-show route, but the wildcard at the
...
// be handled by the intersection logic. Defining tags-union as something separate avoids
// that confusion.
